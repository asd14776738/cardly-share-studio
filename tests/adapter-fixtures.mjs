...
globalThis.fetch = async input => {
  ...
  if (url.startsWith('https://www.instagram.com/p/CODE/embed/captioned/')) return html(`
  ...
  if (url.startsWith('https://www.douyin.com/video/123')) {
...
const cases = [
  ...
  ['网易云音乐', 'https://music.163.com/#/song?id=347230', { platform: 'netease_music', strategy: 'netease-song-api', title: '网易云歌曲', author: '歌手甲', images: 1 }],
  ['QQ音乐', 'https://y.qq.com/n/ryqq/songDetail/SONGMID', { platform: 'qq_music', strategy: 'qqmusic-song-api', title: 'QQ歌曲', author: '歌手乙', images: 1 }],
  ['Telegram', 'https://t.me/channel/123', { platform: 'telegram', strategy: 'telegram-embed', author: '频道作者', images: 1 }],
