...
globalThis.fetch = async input => {
  ...
  if (url.startsWith('https://www.xiaohongshu.com/discovery/item/note-path-dedupe')) return html(`
    <script>window.__INITIAL_STATE__={"note":{"noteId":"note-path-dedupe","title":"小红书路径去重","desc":"同一原图不能重复展示","user":{"nickname":"作者"},"imageList":[{"urlDefault":"https://sns-webpic-qc.xhscdn.com/20260713/spectrum/1040g2sg31q8c90q5h0005pb6c5n8.jpg?imageView2=2&w=1080"},{"urlDefault":"https://sns-webpic-hw.xhscdn.com/20260713/preview/1040g2sg31q8c90q5h0005pb6c5n8.jpg?imageView2=2&w=360"},{"urlDefault":"https://sns-webpic-qc.xhscdn.com/20260713/spectrum/1040g2sg31q8c90q5h0005pb6c5n9.jpg?imageView2=2&w=1080"}]}};</script>`);
  ...
  if (url.startsWith('https://www.instagram.com/p/TRANSFORMED/embed/captioned/')) return html(`
    <script data-sjs>{"post":{"shortcode":"TRANSFORMED","caption":{"text":"One photo, two CDN transforms."},"owner":{"username":"dedupe"},"edge_sidecar_to_children":{"edges":[{"node":{"id":"media-a","display_url":"https://scontent-a.cdninstagram.com/v/t51.2885-15/s640x640/734862615_18604458271006729_2745029679217501525_n.jpg?oh=first"}},{"node":{"id":"media-b","display_url":"https://scontent-b.cdninstagram.com/v/t51.2885-15/e35/734862615_18604458271006729_2745029679217501525_n.jpg?oh=second"}},{"node":{"id":"media-c","display_url":"https://scontent-c.cdninstagram.com/v/t51.2885-15/s640x640/835972726_18604458271006729_2745029679217501526_n.jpg?oh=third"}}]}}}</script>`);
...
const cases = [
  ...
  ['Instagram CDN 变换路径去重', 'https://www.instagram.com/p/TRANSFORMED/', { platform: 'instagram', strategy: 'instagram-json-state', title: '@dedupe on Instagram', author: 'dedupe', images: 2, imageIncludes: '734862615_' }],
  ...
  ['小红书 CDN 变换路径去重', 'https://www.xiaohongshu.com/discovery/item/note-path-dedupe', { platform: 'xiaohongshu', strategy: 'xiaohongshu-initial-state', title: '小红书路径去重', images: 2 }],
